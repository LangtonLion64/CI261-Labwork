...
public class BonusSprite extends AnimatedSprite{
    ...
    public void closeRoutine(){
        Tween.to(tweenData, TweenDataAccessor.TYPE_POS,100f)
                .delay(2000)
                .target(-200,-200).start(tweenManager)
                .setCallback(new TweenCallback() {
                    @Override
                    public void onEvent(int type, BaseTween<?> source) {
                        setAnimation(Animation.PlayMode.NORMAL);
                        TestTweenAnimation.setText("I hope you're prepared for an unforgettable luncheon!");
        ...
        Timeline.createSequence()
                ...
                .setCallback(new TweenCallback() {
                    ...
                    public void onEvent(int type, BaseTween<?> source) {
                        ...
                        TestTweenAnimation.setText("Ah, Superintendent Chalmers, welcome!");
